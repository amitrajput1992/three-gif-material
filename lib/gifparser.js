    ...
    gif[3] === 0x38 && (gif[4] === 0x39 || gif[4] === 0x37) && gif[5] === 0x61) {
      ...
      while (gif[pos] && gif[pos] !== 0x3b) {
        ...
        if (blockId === 0x21) {
          ...
          var _imageData = gif.subarray(offset, pos + 1); // Each frame should have an image and a flag to indicate how to dispose it.
          ...
          var frame = {
            ...
            blob: URL.createObjectURL(new Blob([gifHeader, graphicControl, _imageData]))
          };
          frames.push(frame);
        } else {
    ...
    if (frames.length) {
      ...
      var loadImg = function loadImg() {
        var _loop = function _loop(i) {
          ...
          }.bind(img, null, i); // Link html image tag with the extracted GIF Frame
